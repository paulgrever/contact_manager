...
describe "the company view", type: :feature do
  let(:company) { Company.create(name: 'Sears') }
  ...
  describe "email addresses" do
    before(:each) do
      company.email_addresses.create(address: "test@gmail.com")
      company.email_addresses.create(address: "fake@yahoo.com")
      visit company_path(company)
    end
    ...
    it 'edits an email address' do
      ...
      first(:link, 'edit').click
      page.fill_in('Address', with: 'edited@yahoo.com')
      page.click_button('Update Email address')
      expect(current_path).to eq(company_path(company))
      expect(page).to have_content('edited@yahoo.com')
