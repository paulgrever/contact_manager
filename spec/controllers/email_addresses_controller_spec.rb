...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    {address: "test@yahoo.com", contact_id: 1, contact_type: "Person"}
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'test@yahoo.com', contact_id: alice.id, contact_type: "Person"} }
      ...
      it "redirects to the emails addresses person" do
        alice = Person.create(first_name: 'Alice', last_name: 'Smith')
        valid_attributes = {address: 'test@yahoo.com', contact_id: alice.id, contact_type: 'Person'}
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'bob@yahoo.com', contact_id: bob.id, contact_type: 'Person'} }
      let(:new_attributes) { {address: 'bob2@gmail.com', contact_id: bob.id, contact_type: 'Person'} }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eq('bob2@gmail.com')
      ...
      it "redirects to the email_address" do
        ...
        valid_attributes = {address: 'edit@yahoo.com', contact_id: bob.id, contact_type: 'Person'}
        email_address = EmailAddress.create! valid_attributes
        put :update, {:id => email_address.to_param, :email_address => valid_attributes}, valid_session
